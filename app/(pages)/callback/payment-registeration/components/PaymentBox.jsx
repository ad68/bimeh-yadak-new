...
export default function Index() {
  ...
  return (
    ...
    <section className="flex h-screen w-full items-center justify-center mt-[100px] bg-[#F6F6FB]">
      {actionType === "true" ? <section className="h-[711px] w-[718px] rounded-[24px] bg-white px-8">
        ...
        <section className="mt-[24px]">
          ...
          <section className="flex items-center justify-between rounded-lg bg-[#F6F6FB] px-[24px] py-[18px]">
            <span className="xl:text-lg font-semibold text-[#9295A9]">
              درگاه پرداخت اینترنتی:
            </span>
            <span className="xl:text-lg font-semibold text-[#3E4151]">
              {pspName}
            </span>
          </section>
          ...
          <section className="flex items-center justify-between rounded-lg bg-[#F6F6FB] px-[24px] py-[18px]">
            <span className="xl:text-lg font-semibold text-[#9295A9]">مبلغ:</span>
            <span className="xl:text-lg font-semibold text-[#3E4151]">
          ...
          <section className="flex items-center justify-between rounded-lg bg-[#F6F6FB] px-[24px] py-[18px]">
            <span className="xl:text-lg font-semibold text-[#9295A9]">وضعیت:</span>
            <span className="xl:text-lg font-semibold text-[#1CAE81]">
              پرداخت شده
            </span>
          </section>
        </section>
        <Link
          href={"/relief-signup?success=true&id=" + id}
          className="m-auto mt-[48px] flex h-[48px] w-[280px] items-center justify-center rounded-lg bg-primary text-white"
        >
          بازگشت به وب سایت
        </Link>
      </section> :
        <section className='w-[718px] h-[615px] bg-white rounded-[24px] px-8'>
          ...
          <p className='xl:text-lg font-semibold text-[#909090] mt-[32px] text-justify'>
          ...
          <section className='mt-[24px]'>
            <section className='flex justify-between items-center px-[24px] py-[18px]'>
              <span className='text-[#9295A9] xl:text-lg font-semibold'>کدپیگیری:</span>
              <span className='text-[#3E4151] xl:text-lg font-semibold'>71521354654</span>
            </section>
            <section className='flex justify-between bg-[#F6F6FB] rounded-lg items-center px-[24px] py-[18px]'>
              <span className='text-[#9295A9] xl:text-lg font-semibold'>وضعیت:</span>
              <span className='text-[#E14856] xl:text-lg font-semibold'>پرداخت نشده</span>
            </section>
            <Link href='/' className='bg-primary block w-[280px] text-white rounded-lg m-auto mt-[48px] px-[68.5px] py-[10px]'>
              بازگشت به وب سایت
            </Link>
          </section>
        </section>
