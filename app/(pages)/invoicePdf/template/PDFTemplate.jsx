            ...
            <Page size="A4" style={styles.page}>
                ...
                <View style={styles.table}>
                    ...
                    <View style={styles.tableRow}>
                        ...
                        <Text style={[styles.tableCell, styles.column5]}>{`(${numberWithCommas(additionalEntryFee)} * ${additionalEntryKm})`} {(numberWithCommas(additionalEntryFinalFee))}</Text>
                    </View>

                    <View style={styles.tableRow}>
                        <Text style={[styles.tableCell, styles.column1]}>6</Text>
                        <Text style={[styles.tableCell, styles.column2]}>ورودی امداد بالینی</Text>
                        <Text style={[styles.tableCell, styles.column5]}>{(numberWithCommas(clinicalAssistanceEntryFee))}</Text>
                    </View>
                    <View style={styles.tableRow}>
                        ...
                        <Text style={[styles.tableCell, styles.column5]}>{(numberWithCommas(clinicalAndMobileRepairFee))}</Text>
                    </View>
                    <View style={styles.tableRow}>
                        <Text style={[styles.tableCell, styles.column1]}>8</Text>
                        <Text style={[styles.tableCell, styles.column2]}>هزینه لوازم یدکی</Text>
                        <Text style={[styles.tableCell, styles.column5]}>{(numberWithCommas(sparePartsFee))}</Text>
                    </View>
                    <View style={styles.tableRow}>
                        <Text style={[styles.tableCell, styles.column1]}>9</Text>
                        <Text style={[styles.tableCell, styles.column2]}>آماده سازی</Text>
                        <Text style={[styles.tableCell, styles.column5]}>{(numberWithCommas(setupFee))}</Text>
                    </View>
                    <View style={styles.tableRow}>
                        <Text style={[styles.tableCell, styles.column1]}>10</Text>
                        <Text style={[styles.tableCell, styles.column2]}> سایر موارد</Text>
                        <Text style={[styles.tableCell, styles.column5]}>{(numberWithCommas(otherItemsFee))}</Text>
                    </View>
                    <View style={styles.tableRow}>
                        <Text style={[styles.tableCell, styles.column1]}>11</Text>
                        <Text style={[styles.tableCell, styles.column2]}>پنچرگیری درمحل</Text>
                        <Text style={[styles.tableCell, styles.column5]}>{(numberWithCommas(onSiteTireRepairFee))}</Text>
                    </View>
                    <View style={styles.tableRow}>
                        <Text style={[styles.tableCell, styles.column1]}>12</Text>
                        <Text style={[styles.tableCell, styles.column2]}>پنچرگیری رفت و برگشت</Text>
                        <Text style={[styles.tableCell, styles.column5]}>{(numberWithCommas(roundTripTireRepairFee))}</Text>
                    </View>

                    <View style={styles.tableRow}>
                        <Text style={[styles.tableCell, styles.column1]}>13</Text>
                        <Text style={[styles.tableCell, styles.column2]}>تعویض زاپاس</Text>
                        <Text style={[styles.tableCell, styles.column5]}>{(numberWithCommas(spareTireReplacementFee))}</Text>
                    </View>
                    <View style={styles.tableRow}>
                        <Text style={[styles.tableCell, styles.column1]}>14</Text>
                        <Text style={[styles.tableCell, styles.column2]}>سوخت رسانی</Text>
                        <Text style={[styles.tableCell, styles.column5]}>{(numberWithCommas(fuelDeliveryFee))}</Text>
                    </View>
                    <View style={styles.tableRow}>
                        <Text style={[styles.tableCell, styles.column1]}>15</Text>
                        <Text style={[styles.tableCell, styles.column2]}>فروش باطری</Text>
                        <Text style={[styles.tableCell, styles.column5]}>{(numberWithCommas(batterySaleFee))}</Text>
                    </View>
                    <View style={styles.tableRow}>
                        <Text style={[styles.tableCell, styles.column1]}>16</Text>
                        <Text style={[styles.tableCell, styles.column2]}>دیاگ</Text>
                        <Text style={[styles.tableCell, styles.column5]}>{(numberWithCommas(diagFee))}</Text>
                    </View>
                    <View style={styles.tableRow}>
                        <Text style={[styles.tableCell, styles.column1]}>17</Text>
                        <Text style={[styles.tableCell, styles.column2]}>بازکردن درب خودرو</Text>
                        <Text style={[styles.tableCell, styles.column5]}>{(numberWithCommas(carDoorOpeningFee))}</Text>
                    </View>
                    <View style={styles.tableRow}>
                        <Text style={[styles.tableCell, styles.column1]}>18</Text>
                        <Text style={[styles.tableCell, styles.column2]}>بیرون کشیدن خودرو از ماسه و برف و غیره</Text>
                        <Text style={[styles.tableCell, styles.column5]}>{(numberWithCommas(vehicleExtractionSandSnowEtcFee))}</Text>
                    </View>
                    <View style={styles.tableRow}>
                        <Text style={[styles.tableCell, styles.column1]}>19</Text>
                        <Text style={[styles.tableCell, styles.column2]}>تعویض روغن در محل</Text>
                        <Text style={[styles.tableCell, styles.column5]}>{(numberWithCommas(onSiteOilChangeFee))}</Text>
                    </View>
                    <View style={styles.tableRow}>
                        <Text style={[styles.tableCell, styles.column1]}>20</Text>
                        <Text style={[styles.tableCell, styles.column2]}>فروش روغن موتور و ترمز و ضدیخ</Text>
                        <Text style={[styles.tableCell, styles.column5]}>{(numberWithCommas(saleOfEngineOilBrakeFluidAntifreezeFee))}</Text>
                    </View>
                </View>
