...
export default function Index() {
  ...
  return (
    <section className="mb-[47.39px] flex h-auto w-full flex-col xl:mb-0 xl:h-[681px] xl:w-[460px] ">
      ...
      />
      <section className="w-full border-r-[2px] border-solid border-primary pr-2 text-justify text-sm leading-[24.18px] text-[#505050] xl:text-base xl:leading-[27.64px]">
